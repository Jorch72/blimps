...
public class ItemBlimpCargo extends Item {
    
	public ItemBlimpCargo() {
        super();
        this.maxStackSize = 1;
        ...
        else
        {
            ...
            else
            {
                if (movingobjectposition.typeOfHit == MovingObjectType.BLOCK)
                {
                    ...
                    EntityCargoBlimp entityboat = new EntityCargoBlimp(par2World, (double)((float)i + 0.5F), (double)((float)j + 1.0F), (double)((float)k + 0.5F));
