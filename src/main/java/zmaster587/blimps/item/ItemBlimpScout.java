...
public class ItemBlimpScout extends Item {
    
	public ItemBlimpScout() {
        super();
        this.maxStackSize = 1;
        ...
        else
        {
            ...
            else
            {
                if (movingobjectposition.typeOfHit == MovingObjectType.BLOCK)
                {
                    ...
                    EntityScoutBlimp entityboat = new EntityScoutBlimp(par2World, (double)((float)i + 0.5F), (double)((float)j + 1.0F), (double)((float)k + 0.5F));
